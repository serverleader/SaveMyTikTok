...
generateFunctionMocks = (
    ...
    item: window.utils.createProxy(proto.item, {
    ...
    namedItem: window.utils.createProxy(proto.namedItem, {
        apply(target, ctx, args) {
            if (!args.length) {
                throw new TypeError(
    ...
    refresh: proto.refresh
        ? window.utils.createProxy(proto.refresh, {
            apply(target, ctx, args) {
                return undefined
            }
        })
...
function generateMagicArray(
    ...
    return new Proxy(magicArrayObj, {
        get(target, key = '') {
            ...
            return window.utils.cache.Reflect.get(...arguments)
        },
        ownKeys(target) {
